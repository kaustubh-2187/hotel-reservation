...
class DataProcessor:
    ...
    def preprocess_data(self, df):
        try:
            ...
            skew_threhold = self.config["data_processing"]["skewness_threhold"]
    ...
    def balance_data(self, df):
        try:
            ...
            balanced_df = pd.DataFrame(X_resampled, y_resampled)
    ...
    def process(self):
        try:
            ...
            raise CustomException("Error during the data processing pipeline", e)
